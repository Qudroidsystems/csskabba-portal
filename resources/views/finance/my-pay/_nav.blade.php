...
@php $tabs = ['index' => ['Payslips', 'ri-file-list-3-line'], 'tax' => ['Tax history', 'ri-government-line'], 'pension' => ['Pension', 'ri-shield-user-line'], 'deductions' => ['Deductions', 'ri-indeterminate-circle-line']]; @endphp
