...
.comment-display:empty:before,
.comment-display-mobile:empty:before {
            ...
            <table class="cb-table">
                <thead>
                    <tr>
                        ...
                        <th class="cbcol-guidance" style="min-width:200px;">Counselor's Comment</th>
                        <th class="cbcol-activities" style="min-width:220px;">Remark on Activities</th>
                    ...
                    <div class="card-body-pad">
                        ...
                        <div class="comment-field-group">
                            ...
                            <div class="comment-display-mobile"
                                 ...
                                 data-value="{{ $teacherComment }}"
                                 onclick="openCommentModal('{{ $sid }}', 'teacher', '{{ addslashes($fullName) }}', '{{ $student->admissionNo }}', '{{ $imgUrl }}', {{ json_encode($an) }})"
                                 style="cursor:pointer; padding:10px 12px; background:#f8fafc; border-radius:8px; border:1px solid var(--cb-border); white-space:normal; word-wrap:break-word; font-size:12px; line-height:1.5;">
                                {!! $teacherComment ? nl2br(e($teacherComment)) : '<span style="color:#94a3b8;">— Click to add comment —</span>' !!}
                            </div>
                        </div>
                        ...
                        <div class="comment-field-group mobile-col-absence">
                            ...
                            <input type="number" class="cb-input mob-absence"
                                   data-sid="{{ $sid }}" data-field="absence"
                                   value="{{ $profile ? $profile->no_of_times_school_absent : '' }}"
                                   min="0" placeholder="0" style="max-width:100px;" autocomplete="off">
                        </div>
                    </div>
                </div>
            @endforeach
...
(function () {
    ...
    function onInputChange(e) {
        ...
        refreshCommentDisplay(sid, field, val);
