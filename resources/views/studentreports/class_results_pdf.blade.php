                    ...
                    <thead>
                        <tr>
                            ...
                            @if(in_array('arm_position', $columnsToShow))
                                <th class="col-position">Arm<br>Pos</th>
                            @endif
                            @if(in_array('arm_position_cum', $columnsToShow))
                                <th class="col-position">Arm<br>Cum</th>
                            @endif
                            @if(in_array('position_total', $columnsToShow))
                                <th class="col-position">Cls<br>Pos</th>
                            @endif
            ...
            @if($showMock)
                <div class="mock-section">
                    ...
                    <div class="mock-summary">
                        TOTAL: {{ number_format($mockSummary['obtained'] ?? 0, 1) }}
                ...
                <table>
                    <tr>
                        ...
                        <td class="cell-footer">
                            ...
                            <div style="margin-top:2px;"><strong>Next Term:</strong> <span class="text-dot-space2">
                                @php
