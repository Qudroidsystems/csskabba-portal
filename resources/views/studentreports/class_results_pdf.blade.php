...
<head>
    ...
    <style>
        * {
        ...
        /* =====================================================
           KEY FIX: FLEX LAYOUT — ACADEMIC + PSYCHOMOTOR
           ===================================================== */
        .results-dual-layout {
            display: flex;
            gap: 8px;
            ...
            align-items: flex-start;     /* changed from stretch — prevents height forcing */
            page-break-inside: avoid;
            break-inside: avoid;
            overflow: hidden;            /* contain any overflow inside the flex row */
            width: 100%;
        }

        /* Academic side: takes all remaining space after psychomotor panel */
        .academic-results-container {
            flex: 1 1 0;                 /* grow/shrink freely from 0 basis */
            min-width: 0;                /* allow shrinking below content width */
            max-width: calc(100% - 160px); /* leave exactly 160px for psychomotor + gap */
            overflow: hidden;
        }

        /* Psychomotor side: locked to fixed width, never grows or shrinks */
        .psychomotor-container {
            flex: 0 0 148px;             /* no grow, no shrink, fixed 148px */
            width: 148px;
            min-width: 148px;
            max-width: 148px;
            background: #fef9e6;
        ...
        .psycho-table {
            ...
            font-size: 7.2px;
            table-layout: fixed;         /* fixed layout keeps columns from blowing out */
        }
        ...
        /* ACADEMIC TABLE — table-layout: fixed is the critical addition */
        .result-table table {
            width: 100%;
...
@foreach ($allStudentData as $index => $studentData)
    ...
    <div class="student-section">
        <div class="student-section-inner">
            ...
            <!-- SIDE BY SIDE: ACADEMIC + PSYCHOMOTOR -->
