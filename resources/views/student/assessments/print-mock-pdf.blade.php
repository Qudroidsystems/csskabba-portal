...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* LOGO / CONTACT / PHOTO */
        .header-table { width:100%; border-collapse:collapse; margin:4px 0 3px; }
        .school-logo {
        ...
        .info-table td { padding:3px 5px; text-align:center; font-size:9px; }
        .info-badge {
            background: #fef3c7;
            padding: 2px 8px;
            border-radius: 24px;
        ...
        .info-value { font-weight:900; margin-left:4px; font-size:9.5px; }
        ...
        .stat-label { font-size: 7px; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: .04em; }
        .stat-value { font-size: 12px; font-weight: 900; color: #0f1c35; margin-top: 1px; }
        ...
        .result-table { width:100%; border-collapse:collapse; font-size:8px; }
        ...
        .result-table thead tr.col-label-row th.left-align { text-align:left; padding-left:6px; }
        ...
        .grade-dist-box strong { font-size: 8px; color:#0f1c35; }

        /* REMARKS */
        .remarks-table { width:100%; border-collapse:collapse; margin:4px 0; border:2px solid #000; }
        .remarks-table td { border:1px solid #000; padding:5px 8px; vertical-align:top; font-size:8.5px; background:white; }
        .remark-title { font-weight:900; font-size:8.5px; border-bottom:1.5px solid #94a3b8; display:inline-block; margin-bottom:3px; }
        ...
        .strip-table td { padding:4px 3px; vertical-align:middle; text-align:center; }
        .qr-img    { width:45px; height:45px; display:block; margin:0 auto; }
        .qr-label  { font-size:6.5px; font-weight:700; margin-top:2px; }
        .stamp-img { width:65px; transform:rotate(-6deg); }
        .sign-line { border-bottom:1.5px dotted #1e293b; min-width:80px; display:inline-block; margin:0 4px; }
        .powered   { font-size:6.5px; color:#475569; margin-top:3px; }
            ...
            <table class="result-table">
                <thead>
                    ...
                    <tr class="col-label-row">
                        ...
                        <th class="left-align" style="width:130px;">SUBJECT</th>
                        <th style="width:35px;">EXAM<br><span style="font-size:6px;">(Score)</span></th>
                        <th style="width:48px;">TOTAL<br><span style="font-size:6px;">(/100)</span></th>
                        <th style="width:32px;">GRADE</th>
                        <th style="width:48px;">REMARK</th>
                        <th style="width:35px;">POSITION</th>
                        <th style="width:38px;">CLASS AVG</th>
                        <th style="width:45px;">MIN / MAX</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="subject-name-cell">
                            <div style="font-weight:800;color:#0f1c35;font-size:8px;">{{ $mock->subject_name ?? '—' }}</div>
                            @if(!empty($mock->subject_code))
                                <div style="font-size:6.5px;color:#94a3b8;font-weight:600;">{{ $mock->subject_code }}</div>
                            @endif
                        </td>
                        ...
                        <td style="font-size:7px;color:#6b7280;">{{ $mock->remark ?? '—' }}</td>
        ...
        <table class="remarks-table">
            <tr>
                <td width="50%">
                    ...
                    <span style="font-style:italic;color:#374151;font-size:8px;">
            ...
            <table class="strip-table">
                <tr>
                    ...
                    <td width="60%" style="text-align:center;">
                        <div style="font-size:8px;"><strong>Report Type:</strong> Mock Examination &nbsp;|&nbsp; <strong>Term:</strong> {{ $term }}</div>
                        <div style="margin:3px 0;font-size:8px;"><strong>Issued:</strong> <span class="sign-line">{{ now()->format('jS F, Y') }}</span></div>
                        <div style="font-size:8px;"><strong>Parent / Guardian Signature:</strong> <span class="sign-line"> ________________________ </span></div>
                        <div style="margin-top:4px;">
                            <em style="font-size:6.5px;color:#64748b;">
