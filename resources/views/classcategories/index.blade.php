...
.pass-avg-card.no-category{border-color:#dc2626;background:#fef2f2}
...
.pac-input:disabled{background:#f1f5f9;cursor:not-allowed}
...
.pac-save-btn:disabled{opacity:0.5;cursor:not-allowed}
...
.category-warning{background:#fef2f2;color:#dc2626;padding:4px 8px;border-radius:6px;margin-top:6px;font-size:10px;display:flex;align-items:center;gap:4px}
</style>
